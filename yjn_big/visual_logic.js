 ...
 * Wed Oct 17 2018 17:17:03 GMT+0800 (中国标准时间)
 */
...
registerOnClick("CB", function() {
  assignMat("GuiZi_Z", "GuiZi_Z_chabai");
  assignMat("GuiZi_Znei", "GuiZi_Znei_chabai");
  assignMat("DiX", "DiX_chabai");
}, function() {});

registerOnClick("WH", function() {
  assignMat("GuiZi_Z", "GuiZi_Z_wahui");
  assignMat("GuiZi_Znei", "GuiZi_Znei_wahui");
  assignMat("DiX", "DiX_wahui");
}, function() {});

registerOnClick("ZS", function() {
  assignMat("GuiZi_Z", "GuiZi_Z_zise");
  assignMat("GuiZi_Znei", "GuiZi_Znei_zise");
  assignMat("DiX", "DiX_zise");
}, function() {});

registerOnClick("PTZ", function() {
  assignMat("GuiZi_Y", "GuiZi_Y_putiz");
  assignMat("GuiZi_Ynei", "GuiZi_Ynei_putiz");
  assignMat("DiD", "DiD_putiz");
}, function() {});

registerOnClick("GYJ", function() {
  assignMat("GuiZi_Y", "GuiZi_Y_guiyujin");
  assignMat("GuiZi_Ynei", "GuiZi_Ynei_guiyujin");
  assignMat("DiD", "DiD_guiyujin");
}, function() {});

registerOnClick("JHH", function() {
  assignMat("GuiZi_Y", "GuiZi_Y_jiahuah");
  assignMat("GuiZi_Ynei", "GuiZi_Ynei_jianghuah");
  assignMat("DiD", "DiD_jianghuah");
}, function() {});
